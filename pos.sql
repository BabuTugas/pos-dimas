...
--
-- Host: localhost:3306
-- Waktu pembuatan: 15 Sep 2022 pada 07.38
-- Versi server: 5.7.33
-- Versi PHP: 7.4.19
...
ALTER TABLE `pembelian_detail`
  ...
  ADD CONSTRAINT `pembelian_detail_ibfk_2` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id_produk`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `penjualan_detail`
  ...
  ADD CONSTRAINT `penjualan_detail_ibfk_2` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id_produk`) ON DELETE CASCADE ON UPDATE CASCADE;
