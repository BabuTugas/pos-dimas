    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($member) {
                return '
                    <button type="button" onclick="editForm(`'. route('member.update', $member->id_member) .'`)" class="btn btn-xs btn-warning"><i class="fa fa-edit"> Edit</i></button>
                    <button type="button" onclick="deleteData(`'. route('member.destroy', $member->id_member) .'`)" class="btn btn-xs btn-danger"><i class="fa fa-trash"> Delete</i></button>
                ';
            })
